<div class="dashboard-content active" data-tab="1">
              ...
              <div class="statistical-main">
                    ...
                    const data = google.visualization.arrayToDataTable([
                      ...
                      <?php
                        ...
                        foreach ($catalog as $item) {
                          $i++;
                          if($i==count($catalog)){
                            echo "['".$item['name']."',".countproduct($item['id'])."]";
                          }else{
                            echo "['".$item['name']."',".countproduct($item['id'])."],";
                          }
                        }
                ...
                <div class="statistical-right">
                  <h2 class="title">Lượt xem</h2>
                  <img src="../layout/assets/images/luotxem.png" alt="" />
                </div>
              </div>
              <section class="dashboard-list-pro">
                <div class="container">
                  <div class="heading-title-flex">
                    <h2 class="title mt-0">Top sản phẩm</h2>
                    <div class="dropdown dropdown-150">
                      <div class="dropdown-select dropdown-month">
                        <span>
                          <i class="fa fa-angle-down show-month" aria-hidden="true"></i>
                        </span>
                      </div>
                      <div class="dropdown-list dropdown-show-month">
                        <div class="dropdown-item">Tuần</div>
                        <div class="dropdown-item">Tháng</div>
                      </div>
                    </div>
                  </div>
                </div>
